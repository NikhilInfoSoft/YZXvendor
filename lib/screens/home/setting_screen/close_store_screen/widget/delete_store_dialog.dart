...
import 'delete_success_store_dialog.dart';

class DeleteStoreDialog extends StatefulWidget {
  const DeleteStoreDialog({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Deleting your store will hide it from search in our app. Do you want to delete your store?",
            style: TextStyle(
              color: Color(0xff252733),
              fontSize: 14,
              fontFamily: "Mulish",
